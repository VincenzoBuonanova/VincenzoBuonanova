...
## 🚀 **Currently:**
- **Working At:** [**Envisoft srl**](https://www.envisoft.it), a company committed to environmental protection and nature conservation. We develop software solutions that leverage **IUCN** and **Natura 2000** data to enhance the value of biodiversity credits in **Sites of Community Importance (SCI)**.  
- **Learning:** Innovative approaches to data analysis, interactive dashboard design, and AI integration in web applications.  
- **Seeking:** Opportunities to contribute to impactful projects as a Full-Stack, Front-End, or Back-End Developer, with a particular interest in combining technology and sustainability.  
